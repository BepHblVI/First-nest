...
- Name: search.spec.ts >> キーワードで件数が絞られる
- Location: e2e/search.spec.ts:55:1
  ...
  - main [ref=e2]:
    ...
    - generic [ref=e37]:
      ...
      - generic [ref=e39]:
        ...
        - generic [ref=e41]:
          - textbox "キーワード(100文字以内)" [ref=e42]: E2E アンケートA
          - combobox [ref=e43]:
